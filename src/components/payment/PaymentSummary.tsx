...
import { CreditCard, Calendar, Clock, CheckCircle, AlertTriangle, Download, XCircle, AlertCircle } from 'lucide-react'
...
const PaymentSummary: React.FC<PaymentSummaryProps> = ({
  ...
  const getStatusIcon = () => {
    switch (status) {
      ...
      case 'refunded': return <CreditCard className="w-5 h-5 text-gray-500" />
      default: return null
    }
  }
  ...
  return (
    <Card className="p-6">
      <div className="flex justify-between items-start mb-6">
        ...
        <Badge variant={getStatusColor()} size="md" className="flex items-center">
          {getStatusIcon()}
