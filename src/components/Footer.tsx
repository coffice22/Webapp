        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              ...
              conçu pour répondre aux besoins des entrepreneurs et freelances modernes.
            </p>
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/coffice_dz/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="https://www.linkedin.com/showcase/cofficedz/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-display font-semibold mb-4">Liens rapides</h3>
            <ul className="space-y-2">
              <li><Link to="/" className="text-gray-300 hover:text-white transition-colors">Accueil</Link></li>
              <li><Link to="/espaces" className="text-gray-300 hover:text-white transition-colors">Espaces & Tarifs</Link></li>
              <li><Link to="/domiciliation" className="text-gray-300 hover:text-white transition-colors">Domiciliation</Link></li>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-2">
                <Phone className="w-4 h-4 text-gray-400" />
                <a href="https://wa.me/213795380124" target="_blank" rel="noopener noreferrer" className="text-gray-300 text-sm hover:text-white transition-colors">
