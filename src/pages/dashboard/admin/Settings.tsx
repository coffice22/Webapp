          ...
          <Card>
            ...
            <div className="space-y-4">
              <Input
                ...
                onChange={(e) =>
                  updateGeneral("nom_entreprise", e.target.value)
                }
              />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Input
                  ...
                  onChange={(e) =>
                    updateGeneral("horaires_ouverture", e.target.value)
                  }
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateGeneral("horaires_fermeture", e.target.value)
                  }
                />
              </div>
          ...
          <Card className="mt-6">
            ...
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-sm text-blue-800">
                La tarification est geree directement dans la section{" "}
                <strong>Espaces</strong>. Chaque espace peut avoir ses propres
                tarifs (heure, demi-journee, jour, semaine).
              </p>
            </div>
          </Card>
        </motion.div>
            ...
            <div className="space-y-4">
              <label className="flex items-center justify-between p-4 bg-gray-50 rounded-lg cursor-pointer">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Recevoir un email pour chaque nouvelle reservation
                  </p>
                </div>
                <input
                  type="checkbox"
              ...
              <label className="flex items-center justify-between p-4 bg-gray-50 rounded-lg cursor-pointer">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Rappel 7 jours avant l'expiration d'un abonnement
                  </p>
                </div>
                <input
                  type="checkbox"
              ...
              <label className="flex items-center justify-between p-4 bg-gray-50 rounded-lg cursor-pointer">
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateNotifications("notifications_push", e.target.checked)
                  }
                  className="w-5 h-5 text-accent rounded"
                />
              </label>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                <p className="text-sm text-yellow-800">
                  <strong>Note:</strong> Ces actions affectent le fonctionnement
                  de l'application. Effectuez toute modification avec
                  precaution.
                </p>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      Vider les donnees en cache du navigateur
                    </p>
                  </div>
                  <Button
                    variant="outline"
